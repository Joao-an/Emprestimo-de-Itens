...
<link rel="stylesheet" href="style\index.css">
<body>
<?php include 'services/emprestados.php';?>
<header>
    <hgroup>
...
<main>
    <article>
        <!--Tabela de itens-->
        <table>
            <form action="services/emprestados.php" method="POST">
                <caption id="leg"><h2><a href="meusitens.php">Meus Itens</a> <a href="emprestados.php">Emprestados</a></h2></caption>
                <thead><tr><th style="width: 1%">Devolver</th><th>Item</th><th>Data do Emprestimo</th><th>Previsão Devolução</th><th>Status</th><th>Fone Dono</th></tr></thead>
                <tbody>
                ...
                <tfoot><tr><th><input type="submit" value="Devolver" ></th><th></th><th></th><th></th><th></th><th></th></tr></tfoot>
            </form>
        </table>
    </article>
</main>
